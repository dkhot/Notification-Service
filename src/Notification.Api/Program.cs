...
var connectionString = builder.Configuration.GetConnectionString("NotificationDatabase") ?? "Server=localhost,1433;Database=NotificationService;User Id=sa;Password=Your_password123;";
